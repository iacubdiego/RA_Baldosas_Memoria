...
export default function AdminPage() {
  ...
  const aprobarPropuesta = async (id: string) => {
    ...
    try {
      ...
      if (response.ok) {
        setMensaje({ tipo: 'exito', texto: 'Propuesta aprobada correctamente' })
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ opacity: 0.7, fontSize: '0.9rem' }}>
              Gestión de propuestas de colaboración
            </p>
          </div>
          <a 
            href="/"
        ...
        {loading ? (
          <div style={{
            ...
            <div className="loading" style={{ margin: '0 auto 15px' }} />
              ...
              >
                <div style={{ flex: 1, minWidth: '250px' }}>
                  ...
                  <div style={{ 
                    ...
                    <span>📍 {propuesta.lat.toFixed(4)}, {propuesta.lng.toFixed(4)}</span>
                    <span>📅 {formatearFecha(propuesta.createdAt)}</span>
                    {propuesta.emailContacto && (
                      <span>📧 {propuesta.emailContacto}</span>
                    )}
                  </div>
                </div>
            ...
            <div style={{
              ...
              <div style={{ padding: '20px' }}>
                ...
                <div style={{ 
                  ...
                  {propuestaSeleccionada.emailContacto && (
                    <div>
                      <label style={{ 
                        fontSize: '0.85rem', 
                        color: '#6b7280',
                      ...
                      <a 
                        href={`mailto:${propuestaSeleccionada.emailContacto}`}
                        style={{ color: '#2563eb' }}
                      >
                        {propuestaSeleccionada.emailContacto}
                      </a>
                  ...
                  <div>
                    ...
                    <p style={{ color: '#1a2a3a' }}>
                      {formatearFecha(propuestaSeleccionada.createdAt)}
                    </p>
                  </div>
                </div>
